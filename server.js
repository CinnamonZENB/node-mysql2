...
//view the Records
server.get("/api/account/get", (req, res) => {
...
//Search the Records
server.get("/api/account/get/:u_id", (req, res) => {
  var u_id = req.params.u_id;
  var sql = "SELECT * FROM account_user WHERE u_id=?";
  var values = [u_id];
...
//Update the Records
server.put("/api/updateaccount/:u_id", (req, res) => {
  let sql =
    "UPDATE account_user SET name=?, lastname=?, mail=?, password=?, address=?, st_user=? WHERE u_id=?";
...
//Update the Status
server.put("/api/updatestatususer/:u_id", (req, res) => {
  let sql =
    "UPDATE account_user SET st_user=? WHERE u_id=?";
...
server.delete("/api/account/:id", (req, res) => {
  let sql = "DELETE FROM account_user WHERE u_id = ?";
  let values = [req.params.u_id];
